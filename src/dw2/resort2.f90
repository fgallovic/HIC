...
integer i,j,k
integer gn1,gn2,np,nr,rec,dum1,dum2,nfmax,pom,totsub
real dat(7),T
CHARACTER*6 filename

open(3,form='binary',file='NEZsor2.dat')
...
do rec=1,nr
  do j=1,np
    ...
    write(3) rec
    do i=1,totsub
      read(100+(j-1)*totsub+i,*)
      write(3) i
      do k=1,nfmax
        read(100+(j-1)*totsub+i,*) dat(1:7)
        write(3) dat(2:7)
      enddo
    enddo
  enddo
